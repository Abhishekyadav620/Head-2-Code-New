...
//testresult is array of result from judge0
    ...
    // Increment daily submission count for contribution heatmap
    // Uses upsert to create or increment count for today's date
    try {
      ...
      console.error('Error updating daily submission count:', heatmapError);
    }
    ...
    if (!req.result.problemSolved.includes(problemId)) {
      ...
      try {
        ...
        await checkAndUnlockBadges(req.result._id, {
          type: 'problemSolved',
