...
import { Mail, Lock, User, ArrowRight, Shield, Eye, EyeOff, Sparkles, Zap, Code } from 'lucide-react';
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-4">
          ...
          <NavLink to="/" className="inline-flex items-center gap-2 group w-fit">
            <div className="relative">
              <div className="absolute inset-0 bg-purple-500 rounded-2xl blur-lg opacity-60 group-hover:opacity-100 transition-all duration-300"></div>
              <div className="relative bg-gradient-to-br from-purple-600 to-purple-500 p-2 rounded-2xl shadow-2xl">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-slate-400 font-medium">
              Join thousands of developers mastering algorithms and solving problems.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="flex flex-col items-center gap-2 p-3 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-slate-800 hover:border-purple-500/50 transition-all hover:scale-105">
              ...
              <div className="text-center">
                ...
                <div className="text-[10px] text-slate-500">500+ Problems</div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-3 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-slate-800 hover:border-blue-500/50 transition-all hover:scale-105">
              ...
              <div className="text-center">
                <div className="text-xs font-bold text-white">Compete</div>
                <div className="text-[10px] text-slate-500">Live Contests</div>
              </div>
            </div>
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          ...
          <div className="lg:hidden text-center mb-4">
            <NavLink to="/" className="inline-flex items-center gap-2">
              <div className="relative">
                <div className="absolute inset-0 bg-purple-500 rounded-2xl blur-lg opacity-60"></div>
                <div className="relative bg-gradient-to-br from-purple-600 to-purple-500 p-2 rounded-2xl shadow-2xl">
                  <span className="text-xl font-black text-white">H₂C</span>
                </div>
              </div>
          ...
          <div className="relative group">
            {/* Glow Effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-blue-600 to-blue-600 rounded-3xl opacity-20 blur-xl group-hover:opacity-30 transition-all duration-500"></div>
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-3xl border border-slate-800 p-6 shadow-2xl">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-slate-400">Get started for free</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                ...
                <div>
                  ...
                  {errors.firstName && (
                    <p className="mt-1 text-rose-400 text-xs">{errors.firstName.message}</p>
                  )}
                </div>
                ...
                >
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl opacity-70 group-hover:opacity-100 blur transition-all duration-300"></div>
                  <div className={`relative bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold py-2.5 px-6 rounded-xl transition-all ${
